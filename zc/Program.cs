...
namespace zc
{
    ...
    class Parser
    {
        ...
        {
            return obj is Parser parser &&
                   EqualityComparer<SyntaxToken[]>.Default.Equals(_tokens, parser._tokens) &&
                   _position == parser._position &&
                   EqualityComparer<SyntaxToken>.Default.Equals(Current, parser.Current);
        }
